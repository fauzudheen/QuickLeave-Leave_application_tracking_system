  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="bg-cyan-500 py-16 flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-12">
        <button className="bg-white text-cyan-800 font-bold py-4 px-8 rounded-lg shadow-lg hover:bg-cyan-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 flex items-center">
          <User className="mr-2" />
          Employee
        </button>
        <button className="bg-white text-cyan-800 font-bold py-4 px-8 rounded-lg shadow-lg hover:bg-cyan-100 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 flex items-center">
